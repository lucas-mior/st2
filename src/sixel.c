...
static void
sixel_image_default_pallete(SixelImage *sixel_image) {
    int32 n = 1;
...
static int32
sixel_parser_init(SixelState *sixel_state, bool transparent,
    ...
    while (p < p2) {
        ...
        case PARSE_STATE_DECGRA:
            ...
            if (*p >= '0' && *p <= '9') {
                ...
                if (DEBUGGING) {
                    error("SIXEL: Finalized Raster Attrs:\n");
                    error("Pad=%u, Pan=%u, Ph=%d, Pv=%d\n",
