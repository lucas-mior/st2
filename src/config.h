...
static char *CONF_COLORS_DARK[LENGTH(CONF_COLORS)] = {
    [0] = "#000000",
    [1] = "#ff0000",
    [2] = "#00ff00",
    [3] = "#ffff00",
    ...
    /* 26 transparent colors for dark mode */
    [16] = "#000000",
    [17] = "#3a0000",
    [18] = "#003a00",
    [19] = "#3a3a00",
...
static char *CONF_COLORS_LIGHT[LENGTH(CONF_COLORS)] = {
    [0] = "#d0d0d0",
    [1] = "#cc0000",
    [2] = "#008800",
    [3] = "#aa8800",
    ...
    /* 26 transparent colors for light mode */
    [16] = "#ffffff",
    [17] = "#ffd0d0",
    [18] = "#d0ffd0",
    [19] = "#ffffd0",
...
static Shortcut CONF_KEYBOARD_SHORTCUTS[] = {
    ...
    { ControlMask|ShiftMask, XK_plus,       user_zoom,            {.f = +2} },
    { ControlMask|ShiftMask, XK_underscore, user_zoom,            {.f = -2} },
    ...
    { ControlMask|ShiftMask, XK_D,          user_scroll_down,     {.i = -2} },
    { ControlMask|ShiftMask, XK_U,          user_scroll_up,       {.i = -2} },
    { ControlMask|ShiftMask, XK_F,          user_scroll_down,     {.i = -1} },
    { ControlMask|ShiftMask, XK_B,          user_scroll_up,       {.i = -1} },
    ...
    { Mod1Mask,              XK_plus,       user_zoom,            {.f = +2} },
    { Mod1Mask,              XK_underscore, user_zoom,            {.f = -2} },
    { Mod1Mask,              XK_parenright, user_zoom_reset,      {.f =  0} },
    { Mod1Mask,              XK_c,          user_clipboard_copy,  {.i =  0} },
    { Mod1Mask,              XK_v,          user_clipboard_paste, {.i =  0} },
    { Mod1Mask,              XK_f,          user_scroll_up,       {.i = -1} },
